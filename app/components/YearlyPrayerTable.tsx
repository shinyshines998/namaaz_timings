...
interface YearlyPrayerTableProps {
  prayerTimes: DailyPrayerTimes[]
  title: string
}

const YearlyPrayerTable = ({ prayerTimes, title }: YearlyPrayerTableProps) => {
  ...
  const groupedByMonth = prayerTimes.reduce((acc, day) => {
    ...
    return acc
  }, {} as Record<string, DailyPrayerTimes[]>)
...
export default YearlyPrayerTable
